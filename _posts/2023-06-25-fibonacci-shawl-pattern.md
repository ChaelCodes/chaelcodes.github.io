...
Searching for [existing patterns](https://www.bloglovin.com/blogs/nobleknits-knitting-blog-13039743/10-stunning-fibonacci-shawl-knitting-patterns-7395738467) yielded disappointing results. 1 - they are all knitting, and I can only crochet, but more importantly, 2 - none of them scream Fibonacci sequence to me. The interchanging striped colors really muddy the message for me. Why do they do that?
...
They solve this by having interchanging stripes of the sequence, but we'll fix it by reversing the sequence! This means that our final number of the sequence needs to come first, and as soon as that section is done, we're locked in on the shawl size. There was a lot of math and planning and Google spreadsheets, and a brief period where I thought about expressing recursion using marling, but ultimately, I landed on 55 starting rows, with a final row count of 143. This was a little small for a shawl, but the alternative was 232!!
